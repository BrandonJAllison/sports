        ...
        if (props.sport==="nfl") {
            return (
                <div style={{display: "flex"}}> 
                    <div className="UGameContainer" style={{background: "#4a473f", width: "90vw", minHeight: "20vw"}}>     
                    <h3 style={{background: "#dea300", color: "white", margin: "0", width: "60vw"}}>Upcoming Games - {props.sport.toUpperCase()}</h3>
